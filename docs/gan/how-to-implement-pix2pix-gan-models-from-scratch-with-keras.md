...
Pix2Pix 论文的作者探索了不同的 PatchGAN 配置，包括一个称为 PixelGAN 的 1×1 感受野和一个与输入模型的 256×256 像素图像(重新采样为 286×286)匹配的感受野，称为 ImageGAN。他们发现，70×70 PatchGAN 在性能和图像质量之间取得了最佳平衡。
