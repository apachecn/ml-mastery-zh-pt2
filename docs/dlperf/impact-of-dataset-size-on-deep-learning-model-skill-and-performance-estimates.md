...
报告了每个训练集大小的平均模型表现，如我们所料，随着训练集的增加，测试精度稳步提高。我们还看到平均模型表现从 5，000 个示例下降到 10，000 个示例，这很可能突出了数据样本中的差异已经超过了所选模型配置的容量(层数和节点数)。
...
我们可以看到测试精度从 100 个示例急剧增加到 1000 个示例，之后表现似乎趋于平稳。
