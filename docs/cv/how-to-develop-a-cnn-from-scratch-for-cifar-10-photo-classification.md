...
在这种情况下，我们看到了模型表现的另一个大的改进，很像我们看到的辍学。在这种情况下，从基线模型的约 73%提高到约 84%，提高了约 11%。

```py
> 84.470
```

回顾学习曲线，我们看到模型表现有类似于辍学的改善，尽管损失图表明测试集上的模型表现可能比辍学稍早停滞。
...
我们现在将研究这些技术的改进，看看我们是否能进一步提高模型的表现。具体来说，我们将研究一个变体的辍学正规化，并结合辍学与数据增加。
...
回顾学习曲线，我们可以看到模型收敛得很好，测试数据集上的表现可能停滞在大约 110 到 125 个时期。与固定辍学率的学习曲线相比，我们可以再次看到，学习速度进一步放缓，允许在不过度拟合的情况下进一步细化模型。
