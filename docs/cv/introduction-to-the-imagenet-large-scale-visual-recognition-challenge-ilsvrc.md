...
> 我们提出了一种深度卷积神经网络架构，代号为Inception，负责在 ImageNet 大规模视觉识别挑战赛 2014 (ILSVRC14)中设置分类和检测的新技术。
...
> ……我们提出了明显更精确的 ConvNet 架构，不仅在 ILSVRC 分类和定位任务上实现了最先进的精度，而且还适用于其他图像识别数据集，即使作为相对简单的管道的一部分，它们也能实现出色的表现
