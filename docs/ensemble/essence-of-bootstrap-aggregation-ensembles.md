...
树的差异是可取的，因为它们将增加系综的“*多样性”*，这意味着产生在它们的预测或预测误差中具有较低相关性的系综成员。人们普遍认为，由技巧性和多样性(以不同方式技巧或犯不同错误)的集成成员组成的集成表现更好。
...
我们也可以将抽样方法从引导改为另一种抽样技术，或者更一般地说，完全不同的方法。事实上，这是文献中描述的 bagging 的许多扩展的基础。具体来说，就是尝试让集成成员更加独立，同时保持技巧。
