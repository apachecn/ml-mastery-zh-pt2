...
> 这本书包括九章，分为两个部分，汇集了有监督和无监督集成应用的贡献。
...
我喜欢这本书的水平。它是技术性的，但并不过度，并且基于在监督预测建模项目中使用集成算法的考虑。我认为这是一个很好的实践者合奏学习的教科书。
...
这本书写得很好，涵盖了主要方法，有很好的参考。我认为这是在合奏方法基础上的又一个很好的开端，只要读者对一些数学知识感到满意。我喜欢算法描述和工作示例。
